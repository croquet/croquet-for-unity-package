...
//         GameObject[] allObjects = UnityEngine.Object
//             .FindObjectsOfType<CroquetActorManifest>()
//     .Select(manifest => manifest.gameObject)
//     .ToArray();gameObject;
...
//         Debug.Log($"Making object {spec.cH} of type {spec.type} and instanceID {gameObjectToMake.GetInstanceID()}");
